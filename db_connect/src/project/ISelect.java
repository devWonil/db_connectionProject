...
//	ArrayList<MovieTicketPriceDto> movieTicketPrice(String movieName);
	...
	// 배우에대한 정보리스트 출력 OK
	ArrayList<ActorInfoDto> actorInfo(String actorName);
	// 배우가 찍은 영화 리스트 출력 OK
...
//	// 
	...
	// 영화제목으로 출력
	ArrayList<ActorInfoDto> selectByActorName(String actorName);

	// 개봉일로 출력
	ArrayList<ActorInfoDto> selectByBirthYear(String birthYear);
}
